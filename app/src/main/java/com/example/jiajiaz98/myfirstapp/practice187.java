...
public class practice187 extends AppCompatActivity {
    ...
    public class DrawingView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawText("ጤ", xPos, yPos, mBitmapPaint);
            canvas.drawText("ttae", xPos - 160, yPos + 200, pronunciationPaint);
