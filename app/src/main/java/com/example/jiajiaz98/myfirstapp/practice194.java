...
public class practice194 extends AppCompatActivity {
    ...
    public class DrawingView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawText("ጬ", xPos, yPos, mBitmapPaint);
            canvas.drawText("tchae", xPos - 180, yPos + 200, pronunciationPaint);
